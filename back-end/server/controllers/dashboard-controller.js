...
exports.getTotalRevenueMonth = function (req, res, next) {
    ...
    let query_0 = "SELECT name_item,quantity,price from TRANSACTIONS,ITEMS WHERE TRANSACTIONS.item_id=ITEMS.id AND TRANSACTIONS.timestamp BETWEEN ? AND ?";
...
exports.getTotalRevenue = function (req, res, next) {
    let query_0 = "SELECT price*quantity AS total_price from TRANSACTIONS,ITEMS WHERE TRANSACTIONS.item_id=ITEMS.id";
